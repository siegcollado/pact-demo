...
new AppsyncGatewayStack(app, 'AppsyncGatewayStack', {
...
fs.readFile(path.join(__dirname, '../cdk.out/tree.json'), 'utf8', (err, data) => {
  ...
  const defn =
    JSON.parse(data).tree.children.AppsyncGatewayStack.children.AppsyncGateway.children.Schema.attributes['aws:cdk:cloudformation:props'].definition
